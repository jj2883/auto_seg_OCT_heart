function [y_est] = BM3D_filtering(y, sigma,profile, print_to_screen)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%       
%
...
%%%%
if (exist('sigma') ~= 1),
    sigma               = sigma; %%42.4421 default standard deviation of the AWGN
end
...
y_hat = bm3d_thr(y, hadper_trans_single_den, Nstep, N1, N2, lambda_thr2D,...
...
y_est = bm3d_wiener(y, y_hat, hadper_trans_single_den, Nstep_wiener, N1_wiener, N2_wiener, ...
